...
- [[_COMMUNITY_paymentMethodRoutes.js|paymentMethodRoutes.js]]
...
- [[_COMMUNITY_normalizePart.js|normalizePart.js]]
...
### Community 74 - "paymentMethodRoutes.js"
Cohesion: 0.20
...
### Community 85 - "taxCalculationService.js"
Cohesion: 0.31
...
## Knowledge Gaps
- **1007 isolated node(s):** `backup.sh script`, `name`, `version`, `private`, `workspaces` (+1002 more)
...
- **Why does `hasPermission()` connect `Tax Calculation & Rates (18)` to `Meilisearch Sync Worker (33)`, `Payment Terms & Overdue Calculations`, `documentRoutes.js`, `AnalyticsCharts Module (40)`, `Cheque PDF Rendering & Formatting`, `paymentMethodRoutes.js`, `Web Client Services & Search Combobox`, `API Routes & Pagination Middleware`, `documentsRoutes Module (47)`, `Drawer Module (79)`, `CustomerForm Module (17)`, `Meilisearch Sync Worker (84)`, `db Module (22)`, `Meilisearch Sync Worker (23)`, `Tax Calculation & Rates (24)`, `documentNumberGenerator Module (28)`, `Tax Calculation & Rates (31)`?**
