...
## Corpus Check
- 405 files · ~269,421 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1940 nodes · 3017 edges · 293 communities (121 shown, 172 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 85 edges (avg confidence: 0.58)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c1677ac4`
- Run `git rev-parse HEAD` and compare to check if the graph is stale.
- Run `graphify update .` after code changes (no API cost).

## Community Hubs (Navigation)
- [[_COMMUNITY_Accounts Receivable & Invoice Aging|Accounts Receivable & Invoice Aging]]
- [[_COMMUNITY_Inventory Valuation & Low Stock Reporting|Inventory Valuation & Low Stock Reporting]]
- [[_COMMUNITY_Mobile Exploration & Tab Navigation|Mobile Exploration & Tab Navigation]]
- [[_COMMUNITY_API Gateway Dependencies|API Gateway Dependencies]]
- [[_COMMUNITY_Payment Terms & Overdue Calculations|Payment Terms & Overdue Calculations]]
- [[_COMMUNITY_Web Inventory & Purchase Order Forms|Web Inventory & Purchase Order Forms]]
- [[_COMMUNITY_Web Frontend Dependencies|Web Frontend Dependencies]]
- [[_COMMUNITY_Mobile Task Counters & Dashboard|Mobile Task Counters & Dashboard]]
- [[_COMMUNITY_Mobile App Packaging & Build Properties|Mobile App Packaging & Build Properties]]
- [[_COMMUNITY_Parts De-duplication & Conflict Resolution|Parts De-duplication & Conflict Resolution]]
- [[_COMMUNITY_Cheque PDF Rendering & Formatting|Cheque PDF Rendering & Formatting]]
- [[_COMMUNITY_Mobile Expo Manifest settings|Mobile Expo Manifest settings]]
- [[_COMMUNITY_Web Client Services & Search Combobox|Web Client Services & Search Combobox]]
- [[_COMMUNITY_API Routes & Pagination Middleware|API Routes & Pagination Middleware]]
- [[_COMMUNITY_Auth Permissions & Dashboard Widgets|Auth Permissions & Dashboard Widgets]]
- [[_COMMUNITY_Cycle Count Operations (15)|Cycle Count Operations (15)]]
- [[_COMMUNITY_Meilisearch Sync Worker (16)|Meilisearch Sync Worker (16)]]
- [[_COMMUNITY_CustomerForm Module (17)|CustomerForm Module (17)]]
- [[_COMMUNITY_Tax Calculation & Rates (18)|Tax Calculation & Rates (18)]]
- [[_COMMUNITY_Meilisearch Sync Worker (19)|Meilisearch Sync Worker (19)]]
- [[_COMMUNITY_DocumentInterface Module (20)|DocumentInterface Module (20)]]
- [[_COMMUNITY_Parts Management & Catalog (21)|Parts Management & Catalog (21)]]
- [[_COMMUNITY_db Module (22)|db Module (22)]]
- [[_COMMUNITY_Meilisearch Sync Worker (23)|Meilisearch Sync Worker (23)]]
- [[_COMMUNITY_Tax Calculation & Rates (24)|Tax Calculation & Rates (24)]]
- [[_COMMUNITY_Meilisearch Sync Worker (25)|Meilisearch Sync Worker (25)]]
- [[_COMMUNITY_Meilisearch Sync Worker (26)|Meilisearch Sync Worker (26)]]
- [[_COMMUNITY_Meilisearch Sync Worker (27)|Meilisearch Sync Worker (27)]]
- [[_COMMUNITY_documentNumberGenerator Module (28)|documentNumberGenerator Module (28)]]
- [[_COMMUNITY_Meilisearch Sync Worker (29)|Meilisearch Sync Worker (29)]]
- [[_COMMUNITY_Meilisearch Sync Worker (30)|Meilisearch Sync Worker (30)]]
- [[_COMMUNITY_Tax Calculation & Rates (31)|Tax Calculation & Rates (31)]]
- [[_COMMUNITY_package Module (32)|package Module (32)]]
- [[_COMMUNITY_Meilisearch Sync Worker (33)|Meilisearch Sync Worker (33)]]
- [[_COMMUNITY_Database Migration Scripts (34)|Database Migration Scripts (34)]]
- [[_COMMUNITY_Meilisearch Sync Worker (35)|Meilisearch Sync Worker (35)]]
- [[_COMMUNITY_Meilisearch Sync Worker (36)|Meilisearch Sync Worker (36)]]
- [[_COMMUNITY_Meilisearch Sync Worker (37)|Meilisearch Sync Worker (37)]]
- [[_COMMUNITY_Tax Calculation & Rates (38)|Tax Calculation & Rates (38)]]
- [[_COMMUNITY_InvoiceDetailsModal Module (39)|InvoiceDetailsModal Module (39)]]
- [[_COMMUNITY_AnalyticsCharts Module (40)|AnalyticsCharts Module (40)]]
- [[_COMMUNITY_codeGenerator Module (41)|codeGenerator Module (41)]]
- [[_COMMUNITY_App Module (42)|App Module (42)]]
- [[_COMMUNITY_Meilisearch Sync Worker (43)|Meilisearch Sync Worker (43)]]
- [[_COMMUNITY_Bundle Module (44)|Bundle Module (44)]]
- [[_COMMUNITY_package Module (45)|package Module (45)]]
- [[_COMMUNITY_ReportingPage Module (46)|ReportingPage Module (46)]]
- [[_COMMUNITY_documentsRoutes Module (47)|documentsRoutes Module (47)]]
- [[_COMMUNITY_Parts Management & Catalog (48)|Parts Management & Catalog (48)]]
- [[_COMMUNITY_paymentRoutes Module (49)|paymentRoutes Module (49)]]
- [[_COMMUNITY_reset-project Module (50)|reset-project Module (50)]]
- [[_COMMUNITY_Application Module (51)|Application Module (51)]]
- [[_COMMUNITY_tsconfig Module (52)|tsconfig Module (52)]]
- [[_COMMUNITY_partApplicationRoutes.js|partApplicationRoutes.js]]
- [[_COMMUNITY_customerRoutes Module (54)|customerRoutes Module (54)]]
- [[_COMMUNITY_Meilisearch Sync Worker (55)|Meilisearch Sync Worker (55)]]
- [[_COMMUNITY_goodsReceiptRoutes Module (56)|goodsReceiptRoutes Module (56)]]
- [[_COMMUNITY_brandRoutes.js|brandRoutes.js]]
- [[_COMMUNITY_devDependencies Module (58)|devDependencies Module (58)]]
- [[_COMMUNITY_scripts Module (59)|scripts Module (59)]]
- [[_COMMUNITY_animated-icon Module (60)|animated-icon Module (60)]]
- [[_COMMUNITY_withAndroidBuildFixes Module (61)|withAndroidBuildFixes Module (61)]]
- [[_COMMUNITY_Cycle Count Operations (62)|Cycle Count Operations (62)]]
- [[_COMMUNITY_Cheque Processing (63)|Cheque Processing (63)]]
- [[_COMMUNITY_query_graph Module (64)|query_graph Module (64)]]
- [[_COMMUNITY_test_error_handling Module (65)|test_error_handling Module (65)]]
- [[_COMMUNITY_Tax Calculation & Rates (66)|Tax Calculation & Rates (66)]]
- [[_COMMUNITY_Docker Infrastructure (67)|Docker Infrastructure (67)]]
- [[_COMMUNITY_purchaseOrderPdf Module (68)|purchaseOrderPdf Module (68)]]
- [[_COMMUNITY_arRoutes Module (69)|arRoutes Module (69)]]
- [[_COMMUNITY_documentRoutes.js|documentRoutes.js]]
- [[_COMMUNITY_Meilisearch Sync Worker (71)|Meilisearch Sync Worker (71)]]
- [[_COMMUNITY_Forson Business Suite Module (72)|Forson Business Suite Module (72)]]
- [[_COMMUNITY_Parts Management & Catalog (73)|Parts Management & Catalog (73)]]
- [[_COMMUNITY_Parts Management & Catalog (74)|Parts Management & Catalog (74)]]
- [[_COMMUNITY_Meilisearch Sync Worker (75)|Meilisearch Sync Worker (75)]]
- [[_COMMUNITY_Cycle Count Operations (76)|Cycle Count Operations (76)]]
- [[_COMMUNITY_Meilisearch Sync Worker (77)|Meilisearch Sync Worker (77)]]
- [[_COMMUNITY_Android Adaptive Background Icon 108 Module (78)|Android Adaptive Background Icon 108 Module (78)]]
- [[_COMMUNITY_Drawer Module (79)|Drawer Module (79)]]
- [[_COMMUNITY_Tax Calculation & Rates (80)|Tax Calculation & Rates (80)]]
- [[_COMMUNITY_test-ar-data Module (81)|test-ar-data Module (81)]]
- [[_COMMUNITY_Query First Module (82)|Query First Module (82)]]
...
- [[_COMMUNITY_partMergeRoutes.js|partMergeRoutes.js]]
...
- [[_COMMUNITY_Tax Calculation & Rates (90)|Tax Calculation & Rates (90)]]
- [[_COMMUNITY_taxCalculationService.js|taxCalculationService.js]]
- [[_COMMUNITY_Meilisearch Sync Worker (92)|Meilisearch Sync Worker (92)]]
- [[_COMMUNITY_Home Navigation Route Module (93)|Home Navigation Route Module (93)]]
- [[_COMMUNITY_version Module (94)|version Module (94)]]
- [[_COMMUNITY_DocumentsPage Module (95)|DocumentsPage Module (95)]]
- [[_COMMUNITY_vite Module (96)|vite Module (96)]]
- [[_COMMUNITY_patch_power_search Module (97)|patch_power_search Module (97)]]
- [[_COMMUNITY_patch_settings Module (98)|patch_settings Module (98)]]
- [[_COMMUNITY_reset-dev-db Module (99)|reset-dev-db Module (99)]]
- [[_COMMUNITY_start-dev Module (100)|start-dev Module (100)]]
- [[_COMMUNITY_update-prod Module (101)|update-prod Module (101)]]
- [[_COMMUNITY_test-ar-endpoints Module (102)|test-ar-endpoints Module (102)]]
- [[_COMMUNITY_Cycle Count Operations (103)|Cycle Count Operations (103)]]
- [[_COMMUNITY_test-payment-fix Module (104)|test-payment-fix Module (104)]]
- [[_COMMUNITY_test-payment-methods Module (105)|test-payment-methods Module (105)]]
- [[_COMMUNITY_Database Migration Scripts (106)|Database Migration Scripts (106)]]
- [[_COMMUNITY_backup Module (107)|backup Module (107)]]
- [[_COMMUNITY_Dashboard Enhancement Summary Module (108)|Dashboard Enhancement Summary Module (108)]]
- [[_COMMUNITY_Database Folder Layout Module (109)|Database Folder Layout Module (109)]]
- [[_COMMUNITY_Database Production Upgrade Process Module (110)|Database Production Upgrade Process Module (110)]]
- [[_COMMUNITY_Cheque Processing (111)|Cheque Processing (111)]]
- [[_COMMUNITY_test-power-search Module (112)|test-power-search Module (112)]]
- [[_COMMUNITY_router Module (113)|router Module (113)]]
- [[_COMMUNITY_InventoryPage.jsx|InventoryPage.jsx]]
- [[_COMMUNITY_migrate-prod Module (116)|migrate-prod Module (116)]]
- [[_COMMUNITY_Tax Calculation & Rates (117)|Tax Calculation & Rates (117)]]
- [[_COMMUNITY_Diff-First Output Module (118)|Diff-First Output Module (118)]]
- [[_COMMUNITY_Role Boundary Module (119)|Role Boundary Module (119)]]
- [[_COMMUNITY_Simplify & Prune Module (120)|Simplify & Prune Module (120)]]
- [[_COMMUNITY_Zero-Yapping Policy Module (121)|Zero-Yapping Policy Module (121)]]
- [[_COMMUNITY_Context-Gating Module (122)|Context-Gating Module (122)]]
- [[_COMMUNITY_Targeted Reads Only Module (123)|Targeted Reads Only Module (123)]]
- [[_COMMUNITY_Phase 1 - Clarify Intent Module (124)|Phase 1 - Clarify Intent Module (124)]]
- [[_COMMUNITY_Phase 2 - Graph Context Acquisition Module (125)|Phase 2 - Graph Context Acquisition Module (125)]]
- [[_COMMUNITY_Phase 3 - Architectural Plan Module (126)|Phase 3 - Architectural Plan Module (126)]]
- [[_COMMUNITY_Phase 4 - Generate Coding-Agent Prompt Module (127)|Phase 4 - Generate Coding-Agent Prompt Module (127)]]
- [[_COMMUNITY_Phase 1 Context Acquisition Module (128)|Phase 1: Context Acquisition Module (128)]]
- [[_COMMUNITY_Phase 2 Impact Analysis Module (129)|Phase 2: Impact Analysis Module (129)]]
- [[_COMMUNITY_Phase 3 The Vibe Check Module (130)|Phase 3: The Vibe Check Module (130)]]
- [[_COMMUNITY_Phase 4 Targeted Execution Module (131)|Phase 4: Targeted Execution Module (131)]]
- [[_COMMUNITY_Backend Architecture Module (132)|Backend Architecture Module (132)]]
- [[_COMMUNITY_PartNumberManager.jsx|PartNumberManager.jsx]]
...
- [[_COMMUNITY_setupRoutes.js|setupRoutes.js]]
...
- [[_COMMUNITY_test_db_queries.js|test_db_queries.js]]
...
- [[_COMMUNITY_MobileCounter.jsx|MobileCounter.jsx]]
- [[_COMMUNITY_documentRoutes.js|documentRoutes.js]]
...
- `PurchaseOrderPage()` --calls--> `hasPermission()`  [INFERRED]
  packages/web/src/pages/PurchaseOrderPage.jsx → packages/api/middleware/authMiddleware.js
- `TabLayout()` --calls--> `useColorScheme()`  [INFERRED]
  packages/mobile/src/app/_layout.tsx → packages/mobile/src/hooks/use-color-scheme.web.ts
...
- **Agent Operating Procedures and Guidelines** — _agents_rules_01_efficiency_zero_yapping_policy, _agents_rules_02_graph_protocol_query_first, _agents_rules_03_database_migrations_rule_of_immutability, _agents_workflows_build_feature_feature_implementation_sequence, _agents_workflows_cascade_monorepo_cascade_workflow [INFERRED 0.95]
- **GitHub Actions CI/CD Pipeline** — _github_workflows_ci_ci_workflow, _github_workflows_deploy_deploy_workflow, _github_workflows_docker_publish_docker_publish_workflow, _github_workflows_security_security_scan_workflow, commands_cicd_release_workflow [EXTRACTED 0.95]
- **Document Management Interface Design Specs** — _github_prompts_document_nav_prompt_document_management_interface, _github_prompts_document_nav_prompt_dmi_frontend_implementation, _github_prompts_document_nav_prompt_dmi_display_interaction, _github_prompts_document_nav_prompt_dmi_layout_structure, _github_prompts_document_nav_prompt_dmi_data_migration [EXTRACTED 0.95]
- **Sales Checkout Payments Flow** — docs_features_split_payments, docs_on_account_payments_ar_charges, docs_payment_terms_production_readiness_architecture [INFERRED 0.85]
- **Deployment and Database Migrations Strategy** — readme_docker_deployment, readme_database_initialization, database_readme_production_upgrade, docker_compose_prod_deployment [INFERRED 0.85]
...
## Communities (293 total, 172 thin omitted)
...
Cohesion: 0.12
Nodes (15): 1. Login Screen, 2. Dashboard Screen, 3. Active Count Screen, 4. Log Unassigned Find Screen, 5. Reusable Component: Mobile Counter Keypad, Android App UI Reference Map, 📸 Barcode Scanner Modal (Nested in Count), 📸 Barcode Scanner Modal (Nested in Unassigned Search) (+7 more)

### Community 2 - "Mobile Exploration & Tab Navigation"
Cohesion: 0.12
Nodes (24): styles, TabTwoScreen(), AppTabs(), CustomTabList(), styles, ExternalLink(), Props, HintRowProps (+16 more)

### Community 3 - "API Gateway Dependencies"
Cohesion: 0.05
...
Cohesion: 0.08
Nodes (23): getNextDocumentNumber(), computeDueDate(), parsePaymentTermsDays(), validatePaymentTerms(), db, express, { getNextDocumentNumber }, { hasPermission, protect } (+15 more)

### Community 5 - "Web Inventory & Purchase Order Forms"
Cohesion: 0.11
Nodes (25): PurchaseOrderForm(), SavedSalesPanel(), SearchBar, GoodsReceiptModals(), PriceQuantityModal(), Receipt, cache, enrichApplicationsField() (+17 more)
...
Cohesion: 0.08
Nodes (30): apiClient, CountScreen(), styles, DashboardScreen(), fetchAssignedTasks(), styles, queryClient, TabLayout() (+22 more)
...
Cohesion: 0.08
Nodes (19): amountToWords(), chunkToWords(), { amountToWords }, createChequePdf(), createFallbackPdf(), DEFAULT_PAPER, resolvePaperSize(), ALLOWED_FEED_TYPES (+11 more)

### Community 11 - "Mobile Expo Manifest settings"
Cohesion: 0.07
...
Cohesion: 0.21
Nodes (8): ApplicationSearchCombobox(), NewApplicationModal(), PartForm(), SupplierForm(), FilterBar(), Modal(), TagPopover(), PartApplicationManager()
...
Cohesion: 0.14
Nodes (11): api, ACTION_LABELS, AuditHistoryTab(), CycleCountControlsTab(), EmployeeDetailModal(), EmployeePerformanceTab(), TABS, STATUS_META (+3 more)

### Community 15 - "Cycle Count Operations (15)"
Cohesion: 0.14
Nodes (12): CustomerInvoiceDetailsModal(), CustomerSummaryTable(), InvoiceAgingSummaryChart(), EditHistory(), currency(), ReceivePaymentForm(), Drawer(), DueDateEditor() (+4 more)
...
Cohesion: 0.22
Nodes (18): hasPermission(), LowStockAlertsPanel(), RecentActivityFeed(), RecentSalesPanel(), Header(), Sidebar(), useAuth(), AccountsReceivablePage() (+10 more)
...
Cohesion: 0.09
Nodes (13): { Pool }, db, express, { protect, hasPermission }, router, cron, db, generateCycleCountBatches() (+5 more)
...
Cohesion: 0.08
Nodes (22): db, isAdmin(), jwt, bcrypt, db, express, jwt, { parsePaginationQuery, paginatedResponse } (+14 more)
...
Cohesion: 0.13
Nodes (16): client, isRetryable(), { MeiliSearch }, removePartFromMeili(), retryAsync(), syncPartWithMeili(), wait(), { meiliClient } (+8 more)
...
Cohesion: 0.18
Nodes (15): { activeAliasCondition }, claimEvents(), db, DEFAULTS, getCurrentPartVersionMap(), isStaleEvent(), loadPartDocs(), markDone() (+7 more)
...
Cohesion: 0.23
Nodes (17): asArray(), InventoryMovementReport(), InventoryValuationReport(), LowStockReport(), asArray(), ProfitabilityReport(), RefundsReport(), asArray() (+9 more)

### Community 40 - "AnalyticsCharts Module (40)"
Cohesion: 0.13
Nodes (15): ManagerReviewDesk(), CustomerForm(), InvoiceDetailsModal(), RefundForm(), ReportCard(), DateRangeShortcuts(), PaymentModal(), SplitPaymentModal() (+7 more)
...
Cohesion: 0.18
Nodes (10): apiDir, dbPath, EventEmitter, fakeClient, fakeDbModule, fakeMeiliModule, listenerPath, meiliPath (+2 more)

### Community 44 - "Bundle Module (44)"
Cohesion: 0.20
Nodes (5): Bundle, MainActivity, ReactActivity, ReactActivityDelegate, String

### Community 45 - "package Module (45)"
Cohesion: 0.20
...
Cohesion: 0.09
Nodes (21): [1.4.2] - 2026-05-10, Added, Added, Changed, Changelog, CI/CD, Docs, Docs (+13 more)
...
### Community 50 - "reset-project Module (50)"
Cohesion: 0.22
Nodes (7): exampleDirPath, fs, oldDirs, path, readline, rl, root

### Community 51 - "Application Module (51)"
Cohesion: 0.25
Nodes (5): Application, Configuration, MainApplication, ReactApplication, ReactHost

### Community 52 - "tsconfig Module (52)"
Cohesion: 0.25
...
### Community 58 - "devDependencies Module (58)"
Cohesion: 0.29
Nodes (7): devDependencies, eslint, eslint-config-expo, expo-dev-client, patch-package, @types/react, typescript

### Community 59 - "scripts Module (59)"
Cohesion: 0.29
Nodes (7): scripts, android, ios, lint, reset-project, start, web

### Community 60 - "animated-icon Module (60)"
Cohesion: 0.29
Nodes (4): glowKeyframe, keyframe, logoKeyframe, styles

### Community 61 - "withAndroidBuildFixes Module (61)"
Cohesion: 0.29
...
Cohesion: 0.29
Nodes (6): chequeFiles, connections, fs, graph, nodes, output

### Community 64 - "query_graph Module (64)"
Cohesion: 0.29
Nodes (6): connections, fs, graph, matchingNodes, nodeMap, uniqueConnections

### Community 65 - "test_error_handling Module (65)"
Cohesion: 0.29
Nodes (6): http, jwt, options, payload, req, token

### Community 66 - "Tax Calculation & Rates (66)"
Cohesion: 0.29
...
### Community 70 - "documentRoutes.js"
Cohesion: 0.40
...
Cohesion: 0.25
Nodes (7): db, express, fs, { getNextDocumentNumber }, { parsePaginationQuery, paginatedResponse }, { protect, hasPermission }, router

### Community 80 - "Tax Calculation & Rates (80)"
Cohesion: 0.40
Nodes (3): mockLines, mockParts, mockTaxRates

### Community 81 - "test-ar-data Module (81)"
Cohesion: 0.50
...
### Community 86 - "partMergeRoutes.js"
Cohesion: 0.24
...
### Community 91 - "taxCalculationService.js"
Cohesion: 0.31
Nodes (7): calculateInvoiceTax(), calculateLineTax(), db, storeTaxBreakdown(), validateTaxCalculation(), { calculateInvoiceTax, calculateLineTax, validateTaxCalculation }, db
...
### Community 115 - "InventoryPage.jsx"
Cohesion: 0.47
Nodes (3): StockAdjustmentForm(), TransactionHistoryModal(), InventoryPage()
...
### Community 153 - "setupRoutes.js"
Cohesion: 0.40
Nodes (4): bcrypt, db, express, router
...
### Community 292 - "MobileCounter.jsx"
Cohesion: 0.39
Nodes (5): getPartDisplayName(), getPartSecondaryLabel(), MobileCounter(), StaffDashboard(), StaffProgressTab()

### Community 294 - "documentRoutes.js"
Cohesion: 0.09
Nodes (17): protect(), db, express, { protect }, router, db, express, { protect } (+9 more)

## Knowledge Gaps
- **1007 isolated node(s):** `Migration Naming & Sequencing Rules`, `Added`, `Fixed`, `Added`, `Refactored / Optimized` (+1002 more)
...
- **Why does `hasPermission()` connect `Tax Calculation & Rates (18)` to `Meilisearch Sync Worker (33)`, `Payment Terms & Overdue Calculations`, `documentRoutes.js`, `AnalyticsCharts Module (40)`, `Cheque PDF Rendering & Formatting`, `API Routes & Pagination Middleware`, `Auth Permissions & Dashboard Widgets`, `documentsRoutes Module (47)`, `Drawer Module (79)`, `CustomerForm Module (17)`, `Meilisearch Sync Worker (84)`, `Meilisearch Sync Worker (85)`, `db Module (22)`, `Meilisearch Sync Worker (23)`, `Tax Calculation & Rates (24)`, `documentNumberGenerator Module (28)`, `Tax Calculation & Rates (31)`?**
  _High betweenness centrality (0.129) - this node is a cross-community bridge._
- **Why does `TabLayout()` connect `Mobile Task Counters & Dashboard` to `Mobile Exploration & Tab Navigation`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `useColorScheme()` connect `Mobile Exploration & Tab Navigation` to `Mobile Task Counters & Dashboard`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **What connects `Migration Naming & Sequencing Rules`, `Added`, `Fixed` to the rest of the system?**
