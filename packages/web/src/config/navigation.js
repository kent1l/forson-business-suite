...
export const CATEGORIES = [
    ...
    },
    {
        ...
        items: [
            ...
            { name: 'Concessions Granted', icon: ICONS.tag,     page: 'ar_concessions',    permission: 'ar:view', keywords: ['discount', 'discounts', 'settlement discount', 'write-off', 'write off', 'writedown', 'write down', 'bad debt', 'concession', 'forgiven', 'adjustment'] },
