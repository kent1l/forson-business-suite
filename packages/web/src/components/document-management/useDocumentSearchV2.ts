...
const useDocumentSearchV2 = () => {
    ...
    useEffect(() => {
        const loadDocuments = async () => {
            console.log('%c[useDocumentSearchV2] Loading documents with filters:', 'color: blue;', filters);
            setLoading(true);
            setError(null);
            try {
                const params: any = {
                ...
                console.log('%c[useDocumentSearchV2] API Response:', 'color: green;', data);
                ...
                console.error('%c[useDocumentSearchV2] API Error:', 'color: red;', err);
    ...
    console.log('%c[useDocumentSearchV2] Returning state:', 'color: purple;', { documents, loading, error, hasMore });
