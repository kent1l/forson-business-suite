-- Add permissions for Invoice management
-- Created: 2025-09-20
-- Purpose: Add permissions for delete invoice and edit receipt number functionality

BEGIN;

-- Add new permissions for invoice management
...
-- Grant delete invoice permission to Admin (10) only by default
...
-- Grant edit receipt number permission to Admin (10) and Manager (7) by default
INSERT INTO public.role_permission (permission_level_id, permission_id)
SELECT pl.permission_level_id, p.permission_id
