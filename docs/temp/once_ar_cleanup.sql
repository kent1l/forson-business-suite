-- ============================================================================
-- FORSON BUSINESS SUITE - ONE-TIME A/R CLEANUP & RESET SCRIPT
-- ============================================================================
...
-- 3. Reset invoice status and amount_paid
UPDATE invoice 
...
SELECT 
  ...
  (SELECT COUNT(*) FROM invoice WHERE status != 'Unpaid' OR amount_paid > 0) AS invoices_with_balances,
